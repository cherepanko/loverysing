...
(function (APIErrorCode) {
     ...
     * Code: `503`
     */
    APIErrorCode[APIErrorCode["VOTES"] = 503] = "VOTES";
    /**
     ...
     * Code: `1000`
     */
    APIErrorCode[APIErrorCode["PARAM_PHONE"] = 1000] = "PARAM_PHONE";
    /**
     * This phone number is used by another user
     *
     * Code: `1004`
     */
    APIErrorCode[APIErrorCode["PHONE_ALREADY_USED"] = 1004] = "PHONE_ALREADY_USED";
    /**
     ...
     * Code: `1112`
     */
    APIErrorCode[APIErrorCode["AUTH_DELAY"] = 1112] = "AUTH_DELAY";
    /**
     * Invalid document id
     *
     * Code: `1150`
...
const debug = createDebug__default['default']('vk-io:api');
...
class Upload {
    ...
    async upload(url, { formData, timeout }) {
        ...
        const length = await util.promisify(formData.getLength).call(formData);
        const controller = new abortController.AbortController();
...
const debug$1 = createDebug__default['default']('api-io:collect');
...
const debug$3 = createDebug__default['default']('vk-io:updates');
...
class WebhookTransport {
    ...
    async start({ path = '/', tls, host, port: customPort, next = defaultNextHandler } = {}) {
        ...
        try {
            ...
            debug$3(`Webhook listening on port: ${port}`);
        }
        catch (error) {
            this.started = false;
            throw error;
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
    ...
    for (let i = 1, key = 'attach1'; attachments[key] !== undefined; i += 1, key = `attach${i}`) {
        ...
        message.attachments.push(handler(attachments, key, type));
    }
...
class MessageContext extends Context {
    ...
    applyPayload(payload) {
        ...
        this.text = message.text
            ...
            : undefined;
        this[kAttachments$1] = transformAttachments(message.attachments, this.api);
...
const debug$4 = createDebug__default['default']('vk-io:updates');
// eslint-disable-next-line @typescript-eslint/no-explicit-any
